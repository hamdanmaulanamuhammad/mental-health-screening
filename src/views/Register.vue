      ...
      <form @submit.prevent="handleSubmit">
        <div class="mb-5">
          ...
          <input
            ...
            :class="{ 'border-red-400': error && !fullName }"
          />
        </div>
        <div class="mb-5">
          ...
          <input
            ...
            class="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition duration-200"
            :class="{ 'border-red-400': error && !email }"
          />
        </div>
        <div class="mb-5">
          <label for="age" class="block text-gray-700 font-medium mb-2">Umur</label>
          <input
            id="age"
            v-model.number="age"
            type="number"
            ...
            class="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition duration-200"
            :class="{ 'border-red-400': error && !age }"
          />
        </div>
        <div class="mb-5">
          ...
          <select
            ...
            v-model="gender"
            class="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition duration-200"
            :class="{ 'border-red-400': error && !gender }"
          >
        ...
        <div class="mb-6">
          ...
          <div class="relative">
            <input
              ...
              class="w-full p-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition duration-200"
              :class="{ 'border-red-400': error && !password }"
            />
            <button
              type="button"
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (!fullName.value || !email.value || !age.value || !gender.value || !password.value) {
